...
| Day 27 | seek and tell function | [View Code](https://github.com) | Mastered file pointer manipulation using `.seek()` to move the cursor and `.tell()` to track its position. Explored file resizing via `.truncate()` and understood byte-based navigation within files. |

| *Day 27* | seek and tell function | [View here tomorrow Code]() | *Next Python topic will be uploaded ! |
