...
| *Day 12* | Quiz Game | [View Code](Day13_Quiz_Game.py) | Created a dynamic quiz game using `random.choice()`, loops, and tuples. Implemented input normalization with `.strip()` and `.lower()` for case-insensitive validation. |
| *Day 13* | next day.. | [View here tomorrow Code]() | *Next Python topic will be uploaded ! |
