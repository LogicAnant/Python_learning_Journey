...
| *Day 8* | | [View Code](https://github.com/LogicAnant/Python_learning_Journey/blob/main/Day08_password_manager.py) | Created a dynamic password system using nested `match-case` statements and structural pattern guards. |
