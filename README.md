...
| *Day 21* | Python Modules & Imports | [View Code](https://github.com/LogicAnant/Python_learning_Journey/blob/mainDay21_importing_module.py) | Explored Python's import mechanics using `import`, `from`, `as` keywords, and the `dir()` introspection function. Learned why wildcard (`*`) imports cause namespace pollution and how to avoid variable shadowing. |
| *Day 22* | Short hand if else statement | [View here tomorrow Code]() | *Next Python topic will be uploaded ! |
