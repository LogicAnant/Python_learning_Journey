...
| *Day 8* | Match-Case Menu Program | [View Code](https://github.com/LogicAnant/Python_learning_Journey/blob/main/Day07_march_statement.py) | Created a structural pattern matching menu program using `match-case` to handle user choices for multiple utilities. |
