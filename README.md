...
| *Day 6* | For Loop & Range Function | [View Code](https://github.com/Python_learning_Journey/blob/main/Day06_forloop&range.py) | Created an interactive multiple-choice quiz program using `for` loop, `range()` function, and conditional statements. |
