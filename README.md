...
[Open In Github Codespaces](https://github.com/codespaces/automatic-invention-wvvp644pxvx7c5v9v)
...
| *Day 26* | Advanced File I/O: Readlines & Writelines | [View Code](https://github.com/LogicAnant/Python_learning_Journey/blob/main/Day26_readlines_and_other_method.py) | Mastered bulk file operations using `.readlines()` and `.writelines()`. Learned the architectural differences between line-by-line buffering (`readline`) vs bulk reading (`readlines`) and optimized data writing sequential streams. |
| *Day 27* | seek and tell function | [View Code](https://github.com/LogicAnant/Python_learning_Journey/blob/main/Day27_seek&tell()_function.py) | Mastered file pointer manipulation using `.seek()` to move the cursor and `.tell()` to track its position. Explored file resizing via `.truncate()` and understood byte-based navigation within files. |
| *Day 28* | Lambda Functions | [View Code](https://github.com/LogicAnant/Python_learning_Journey/blob/main/) | Mastered anonymous (lambda) functions in Python. Learned to write concise, single-expression functions with multiple arguments, execute immediately invoked lambdas, and use them as arguments for short, clean operations. |
| *Day 29* | Lambda Function | [View here tomorrow Code]() | *Next Python topic will be uploaded ! |
