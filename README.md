...
| Day 10 | List Methods | [View Code](Day10_list_methods.py) | Mastered various list operations and built-in methods including `.sort()`, `.reverse()`, `.append()`, `.insert()`, `.index()`, `.extend()`, `.count()`, and `.copy()`. Also practiced list sum dynamically using f-strings. |
| *Day 10* | List methods | [Vihere tomorrowew Code]() | *Next Python topic will be uploaded ! |
