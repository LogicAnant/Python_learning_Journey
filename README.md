...
| **Day 20** | Short-Hand If/Else & Enumerate | [View Code](https://github.com) | Explored clean coding techniques including single-line ternary conditional statements. Mastered the `enumerate()` function to simultaneously track loop indices and item values cleanly without manual counter variables. |
| *Day 20* | Short hand if else statement | [View here tomorrow Code]() | *Next Python topic will be uploaded ! |
