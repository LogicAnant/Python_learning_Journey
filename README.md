...
| *Day 25* | Variable Scope & File Handling Basics | [View Code](https://github.com/LogicAnant/Python_learning_Journey/blob/main/) | Explored local vs. global variable scopes using the `global` keyword. Mastered basic file I/O operations including reading, writing, appending, and leveraging the contextual `with` statement for automatic resource management. |
