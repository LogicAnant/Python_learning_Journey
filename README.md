...
| *Day 12* | Quiz Game | [View Code](https://github.com/LogicAnant/Python_learning_Journey/blob/main/Day12_Quiz_Game.py) | Created a dynamic quiz game using `random.choice()`, loops, and tuples. Implemented input normalization with `.strip()` and `.lower()` for case-insensitive validation. |
